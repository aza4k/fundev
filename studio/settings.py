...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-g8l4gq*=b9)q7gcmt*f5rzy1h+rg_sgu_vhkmt*8)knd7ezpop')
...
# Database
# Use Railway variables or fall back to local
DATABASES = {
    'default': {
